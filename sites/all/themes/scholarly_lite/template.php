...
function scholarly_lite_preprocess_page(&$variables) {
	...
	if($header_top_left && $header_top_right) { 
		$variables['header_top_left_grid_class'] = 'col-md-8 col-sm-10';
		$variables['header_top_right_grid_class'] = 'col-md-4 col-sm-2';
	...
	if($footer_top_left && $footer_top_right) { 
		...
		$variables['footer_top_right_grid_class'] = 'col-md-12';		
	}
